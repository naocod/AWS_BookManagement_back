...
public class AuthenticationService implements UserDetailsService{
	...
	public JwtRespDto signin(LoginReqDto loginReqDto) {
		...
		UsernamePasswordAuthenticationToken authenticationToken = 
				new UsernamePasswordAuthenticationToken(loginReqDto.getEmail(), loginReqDto.getPassword());	// email과 password를 managet가 알아볼 수 있게 변경
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		User userEntity = userRepository.findUserByEmail(username); // 전달된 username과 동일한 user객체 가져옴
